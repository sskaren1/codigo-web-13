...
// Tarea
const numero_1 = +prompt("Ingrese un numero 1");
const numero_2 = +prompt("Ingrese un numero 2");
const numero_3 = +prompt("Ingrese un numero 3");

let numeroMayor = numero_1;
...
let result= `El numero mayor es ${numeroMayor}`
console.log(result);
